  ...
  return (
    <div className="footer">
      ...
      <div className="f-content" id="contactdetails">
        ...
        <span>
          <a
            href="https://www.ontoplist.com/marketing-agencies/"
            target="_blank"
          >
            <img
              src="https://www.ontoplist.com/images/ontoplist31.png?id=62eb9cf5716ee"
              alt="Best Digital Marketing Agencies - OnToplist.com"
              border="0"
            />
          </a>
        </span>
