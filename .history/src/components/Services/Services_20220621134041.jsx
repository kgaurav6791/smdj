  ...
  return (
    <div className="services" id="services">
      ...
      <div className="awesome">
        ...
        <span>
          Weddings, Birthdays, Anniversaries, Parties, New Year, or any other
          occasion
          <br />
          We have more than a decade of experience ,conducted hundreds of events
          <br />
          and will be able to seamlessly setup in any venue throughout Lucknow.
          <br />
          At the most competitive prices in City.
        </span>
        <a href={Resume} download>
          <button className="button s-button">View Gallery</button>
        </a>
