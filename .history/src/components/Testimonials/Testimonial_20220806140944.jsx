...
const Testimonial = () => {
  const clients = [
    ...
    },
    {
      img: profilePic2,
      review:
        "साउंड क्वालिटी बहुत ही अच्छी है, सुनने में बहुत अच्छा और मीठा साउंड हैं,और डिस्क जॉकी गाना बजाने वाले का बहुत अच्छा और हेल्पफुल नेचर है। ",
    },
    {
      img: profilePic3,
      review:
    ...
    },
    {
      img: profilePic4,
      review:
        "थैंक यू , SM DJ  हमारी शादी को और भी यादगार बनाने के लिए। आपका बहुत बहुत धन्यवाद । ",
    },
  ];
