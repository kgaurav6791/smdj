        ...
        onScreenChange={(boolscreen) => {
          ...
          if (boolscreen === true) {
            ...
            async function locktolandscape() {
              ...
              document.querySelector(".imagegallery").style.display = "flex";
              document.querySelector(".imagegallery").style.alignItems =
                "center";
            }
            locktolandscape();
          } else if (boolscreen === false) {
            document.querySelector(".imagegallery").style.display = "static";
