      ...
      {modal && (
        <div className="modal">
          ...
          <div className="modal-content">
            ...
            <ul>
              <li>
                Administrative permissions are responsibility of customer.{" "}
              </li>
              <li>
              ...
              <li>
                50% Non-refundable advance will need to be paid at time of
                booking.{" "}
              </li>
              <li>
              ...
              <li>
                Hon'ble High Court UP has the sole and final jurisdiction over
                all dispute.
              </li>
            </ul>
