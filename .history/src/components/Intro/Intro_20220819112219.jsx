    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>
            <p>
              Lucknow's best DJ! With over 800 shows in a 12 yr career!If you
              want an experienced DJ, then book US! We have a library of 10,000+
              songs of genres like Bollywood, Commercial House, EDM, Hip-bounce,
