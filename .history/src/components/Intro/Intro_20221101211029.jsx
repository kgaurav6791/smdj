        ...
        <div className="i-name">
          ...
          <span>
            <p>
              ...
              10,000+ songs & musics belonging to genres like <a target="_blank" style={{    color:"var(--gray)",textDecoration:"none"}} href="https://www.britannica.com/topic/Bollywood-film-industry-India">Bollywood</a>, Commercial House, <a style={{    color:"var(--gray)",textDecoration:"none"}} href="https://edm.com/">EDM</a>,
              Hip-bounce, International, <a style={{    color:"var(--gray)",textDecoration:"none"}} href="https://www.britannica.com/topic/Bollywood-film-industry-India">Bollywood</a>, Commercial House, <a style={{    color:"var(--gray)",textDecoration:"none"}} href="https://en.wikipedia.org/wiki/Music_of_Punjab">Punjabi</a> and <a style={{    color:"var(--gray)",textDecoration:"none"}} href="https://en.wikipedia.org/wiki/Rock_music">Rock</a>!!
            </p>
            <p>
