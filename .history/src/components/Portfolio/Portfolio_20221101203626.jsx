  ...
  const mobilesizedvideos = [
    {
      ...
      //DONOT MAKE LAZY EVEN FOR OPTIMIZATION.IT WILL MESS WITH POSITIONING OF PLAY BUTTON DURING TRANSITION ON SLOW NETWORKS
      loading: "eager",
      originalHeight: "640",
      originalWidth: "480",
    },
    {
      original: vidthumb2,
      originalAlt: "SM DJ AND ALL KINDS OF SOUND SERVICES",
      loading: "eager",
      originalHeight: "640",
      originalWidth: "480",
    },
    ...
    {
      original: vidthumb6,
      originalAlt: "Disc jockey IN LUCKNOW",
      loading: "eager",
      originalHeight: "640",
      originalWidth: "480",
    },
