...
import vidthumb1 from "../../vid/SMDJ-VIDEO (1).webp";
import vidthumb2 from "../../vid/SMDJ-VIDEO (2).webp";
import vidthumb3 from "../../vid/SMDJ-VIDEO (3).webp";
import vidthumb4 from "../../vid/SMDJ-VIDEO (4).webp";
import vidthumb5 from "../../vid/SMDJ-VIDEO (5).webp";
import vidthumb6 from "../../vid/SMDJ-VIDEO (6).webp";
import vidthumb7 from "../../vid/SMDJ-VIDEO (7).webp";
import vidthumb8 from "../../vid/SMDJ-VIDEO (8).webp";
import vidthumb9 from "../../vid/SMDJ-VIDEO (9).webp";
import vidthumb10 from "../../vid/SMDJ-VIDEO(10).webp";
...
const Portfolio = () => {
  ...
  const mobilesizedvideos = [
    {
      original: vidthumb1,
      originalAlt: "SM DJ LUCKNOW VIDEO",
      loading: "eager",
      originalHeight: "640",
      originalWidth: "480",
    },
  ...
  const fullSizedVideos = mobilesizedvideos.map((vidimg) => {
    console.log(vidimg.original);
  });
  return (
    <>
