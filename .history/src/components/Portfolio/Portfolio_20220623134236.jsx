...
const Portfolio = () => {
  ...
  const [trackClickOnMainImage, setTrackClickOnMainImage] = useState(true);
  const [trackVideoDisplay, setTrackVideoDisplay] = useState(true);

  useEffect(() => {
    console.log(refImg.current.getCurrentIndex());
  }, [trackClickOnMainImage]);
  ...
  return (
    <>
      ...
      <div>
        {trackVideoDisplay && (
          <Player ref={refVideo} playsInline>
            {/* <source src="https://media.w3.org/2010/05/sintel/trailer_hd.mp4" />
             */}
            <source src="../../vid/SMDJ-VIDEO (5).mp4" />
          </Player>
        )}
      </div>
    </>
